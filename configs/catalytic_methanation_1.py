...
SENSOR_CONFIGS = {
    ...
    "reactor_pressure_sensor": {
        ...
        "unit":        "psia",
        "pin":         "AIN2",
        "calibration": lambda v: max(0.0, 15.8898 * v - 7.68),
    },
    "heater_temp_sensor": {
...
CONTROL_LOOP_CONFIGS = {
    "pressure": {
        ...
        "input_pin":        "AIN2",
        "output_pin":       "DAC0",
        "calibration":      lambda v: max(0.0, 15.8898 * v - 7.68), #0-30psia, adujsted for broken sensor offset. (outputs 12.52psig at atmospheric pressure)
        "setpoint_min":     0.0,
        "setpoint_max":     30.0,
