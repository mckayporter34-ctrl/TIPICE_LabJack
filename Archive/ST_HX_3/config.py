...
# ── LabJack connection ─────────────────────────────────────────────────────────
ETHERNET_ADDRESS = "10.8.112.113"          # e.g. "10.8.112.XX"

# ── Fixed digital outputs ──────────────────────────────────────────────────────
MAIN_POWER_PIN  = "DIO2"           # e.g. "FIO6"
PUMP_SWITCH_PIN = "DIO3"           # AMT369E-98 pump switch 
...
CONTROL_LOOP_CONFIGS = {
    ...
    "level": {
        ...
        "default_setpoint": 0,
        "pid_defaults":     {"Kc": -75.0, "Ti": 5, "Td": 0.0},
    ...
    "flowrate": {
        ...
        "default_setpoint": 0,
        "pid_defaults":     {"Kc": 0.2254, "Ti": 0.1321, "Td": 0.0},
        "extra_sensor_key": None,
    },
    ...
    "steam_pressure": {
        ...
        "calibration":      _make_pressure_cal(0.0, 150.0, V_min = 0.479), #adjusted V_min to 0.479 to match the sensor's actual output at 4 mA
        "setpoint_min":     0,             # TODO: set appropriate min pressure in psig
        "setpoint_max":     150,
        "default_setpoint": 0,
        "pid_defaults":     {"Kc": 0.1501, "Ti": 0.1116, "Td": 0.0},
        "extra_sensor_key": None,
    },
}
